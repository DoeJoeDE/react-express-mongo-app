...
export default class EditExercise extends Component {
    ...
    componentDidMount() { // componentDidMount is a so called life cycle method in React which will always be called at some point, in this case right before anything displays on the page
        ...
        axios.get('http://localhost:5000/exercises/'+this.props.match.params.id) // get the exercise with the matching id
            .then( res => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/exercises/update/' + this.props.match.params.id, exercise) // post the exercise-object to the indicated address
